...
export type UsersTable_viewer$data = {
  ...
  readonly " $fragmentType": "UsersTable_viewer";
};
export type UsersTable_viewer$key = {
  readonly " $data"?: UsersTable_viewer$data;
...
const node: ReaderFragment = {
  ...
  "metadata": {
    "refetch": {
      ...
      "operation": require('./UsersTableQuery.graphql')
    }
  },
